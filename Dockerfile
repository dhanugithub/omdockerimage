...
RUN groupadd -r -g 0 ubuntu && useradd -r -u 0 -g 0 -d /home/ubuntu -s /bin/bash -G root ubuntu && echo "ubuntu ALL=(ALL) NOPASSWD:ALL" | tee /etc/sudoers.d/ubuntu && chmod -R 0440 /etc/sudoers.d/ubuntu
