...
RUN groupadd -r -g 1001 ubuntu && useradd -d /home/ubuntu -ms /bin/bash -r -u 1000 ubuntu -g 1001 ubuntu ubuntu && echo "ubuntu ALL=(root) NOPASSWD:ALL" > /etc/sudoers.d/ubuntu && chmod 0440 /etc/sudoers.d/ubuntu
